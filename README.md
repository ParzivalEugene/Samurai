...
| **tr_trans \<source lang> \<target lang> \<message>** | Translate ***message*** from ***source lang*** to ***taget lang***. |
| **tr_trans \<target lang> \<message>** | Determines the language of the original message and translates ***message*** into ***taget lang***. |
