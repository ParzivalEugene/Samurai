...
**.{commands_names.mini_cogs.get_quote}** - вдохновит тебя на грядущий день"""
        ...
        "music_player":     {
            ...
            "join":               {
                ...
                "queue_is_empty":     [
                    "Дорогой, очередь пустая", "Зайка, в очереди пусто, укажи что воспроизвести", "Сладенький, укажи, что мне играть"
                ],
                "already_in_channel": [
                    "Котик, я уже сижу с тобой", "Сладенький, я уже в твоем голосовом канале", "Зайка, я и так в твоем голосовом канале"
                ],
                "success":            [
            ...
            "play":               {
                "playback_resumed": [
                    "Восстановил воспроизведение", "Музыка снова играет"
                ],
                "title":            "Выберите песню",
                "query_results":    "Результаты поиска",
                "invoked_by":       "Запрошено {}",  # {} - ctx.author.display_name
                "success_title":    "Добавил трек в очередь",
            },
            "pause":              {
                "success":        [
                    "Поставил трек на паузу", "Музыка остановлена", "Приостановил воспроизведение"
                ],
                "already_paused": [
                    "Солнышко, музыка и так остановлена", "Зайка, плеер уже стоит на паузе", "Малыш, я и так остановил воспроизведение"
                ]
            },
            "stop":               {
                "success": [
                    "Остановил проигрывание и очистил плеер", "Музыка остановлена и плеер чист", "Зайка, убрал эту надоедливую музыку"
                ]
            },
            "skip":               {
                "success":        [
                    "Проигрываю следующий трек в очереди", "Для тебя зайка, все что угодно", "Следующий трек на подходе"
                ],
                "queue_is_empty": [
                    "Очередь пуста, я не смогу воспроизвести следующий трек", "Зайка, очередь пуста, нечего скипать", "Солнышко, это последний трек в очереди, мне больше нечего играть"
                ],
            },
            "previous":           {
                "success":        [
                    "Проигрываю предыдущий трек из очереди", "Возвращаемся к прошлому треку"
                ],
                "queue_is_empty": [
                    "Очередь пуста, я не смогу воспроизвести предыдущий трек", "Малыш, очередь пуста"
                ]
            },
            "shuffle":            {
                "success":        [
                    "Успешно перемешал очередь", "Перемешал треки, зайки мои", "Треки были успешно перемешаны"
                ],
                "queue_is_empty": [
                    "Очередь пустая, а я не умею перемешивать пустоту", "Зайка, в очереди пусто", "Солнышко, добавь треки в очередь, чтобы я мог их перемешать"
                ],
            },
            "loop":               {
                "success":           {
                    "none": [
                        "Отключил повтор", "Повтор был успешно отключен"
                    ],
                    "one":  [
                        "Трек успешно зациклен", "Теперь этот трек играет на повторе"
                    ],
                    "all":  [
                        "Эти треки будут зациклены для вас, мои сладкие", "Зациклил очередь", "Теперь эти треки будут зациклены"
                    ]
                },
                "invalid_loop_mode": [
                    "Зайка, я могу зациклить либо все **(all)**, либо трек **(1)**, либо отключить зацикливание **(none)**",
                    "Солнышко, для этой функции я знаю только эти параметры: **all, 1, none**"
                ]
            },
            "queue":              {
                "embed":          {
                    "title":          "Очередь",
                    "description":    "Первые {} треков",  # {} - show,
                    "current_field":  {
                        "name":  "Сейчас играет",
                        "value": [
                            "Очередь пуста", "В очереди нет треков", "В очереди нет музыки"
                        ]
                    },
                    "upcoming_field": {
                        "name": [
                            "Далее в очереди", "Следующий треки", "Остальные треки в очереди"
                        ]
                    },
                    "footer":         "Запрошено {}",  # {} - ctx.author.display_name
                },
                "queue_is_empty": [
                    "Очередь пуста", "В очереди нет треков", "В очереди нет музыки"
                ]
            ...
            "volume":             {
                "success":         "Громкость звука: {:.2f}",  # {} - volume
                "volume_too_low":  [
                    "Зайка, минимальное значение звука 0", "Солнышко, я не могу поставить звук ниже 0"
                ],
                "volume_too_high": [
                    "Зайка, максимальное значение звука 150", "Зайчик, я не могу поставить звук выше 100"
                ],
                "max_volume":      [
                    "Солнышко, громкость звука и так максимальна", "Зайчик, звук и так на максимуме"
                ],
                "min_volume":      [
                    "Зайчик, плеер уже в муте", "Громкость звука уже 0"
                ]
            },
            "lyrics":             {
                "no_lyrics": [
                    "К сожалению я ничего не нашел :(", "Зайка, мне не удалось ничего найти", "Не нашел никакой информации :("
                ]
            },
            "equalizer":          {
                "success":        [
                    "Установил тип эквалайзера: **{}**", "Эквалайзер: **{}**", "Режим постобработки: **{}**",  # {} - preset
                ],
                "invalid_preset": [
                    "Зайка, есть только 4 типа эквалайзера: **flat**, **boost**, **metal** и **piano**",
                    "Солнышко, я знаю только 4 типа эквалайзера: **flat**, **boost**, **metal** и **piano**",
                    "Ласточка я могу настроить только 4 типа эквалайзера: **flat**, **boost**, **metal** и **piano**"
                ]
            },
            "advanced_equalizer": {
                "success":       [
                    "Успешно установил эквалайзер", "Задал настройку на частоты", "Изменил состояние эквалайзера"
                ],
                "no_band":       [
                    "Я могу настроить только 15 диапазонов эквалайзера или данные частоты: {}",
                ],  # {} -  ", ".join(str(b) for b in HZ_BANDS)
                "out_of_bounds": [
                    "Зайка, диапазон громкости от -10dB до 10dB", "Солнышко, громкость должна быть от -10dB до 10dB"
                ]
            },
            "now_playing":        {
                "embed":    {
                    ...
                    "artist":        "Исполнитель",
                    "time_position": "Длительность"
                },
                "no_track": [
                    "Зайка, сейчас очередь пуста", "Солнышко, на данный момент плеер не активен", "Сейчас ничего не играет, зайчик мой"
                ]
            },
            "skipto":             {
                "success":        [
                    "Успешно установил новый трек", "Следующий трек на подходе", "Пропустил очередь до данного трека"
                ],
                "queue_is_empty": [
                    "Очередь пуста, я не смогу воспроизвести следующий трек", "Зайка, очередь пуста, нечего скипать", "Солнышко, это последний трек в очереди, мне больше нечего играть"
                ],
                "no_more_tracks": [
                    "Солнышко, этот индекс находится за пределами длины очереди"
                ]
            },
            "restart": {
                "success": [
                    "Начал воспроизведение заново", "С удовольствием сыграю этот трек еще", "Запустил трек по новой"
                ],
                "queue_is_empty": [
                    "Сладенький, очередь пуста", "Солнышко, я не могу воспроизвести пустоту снова"
                ]
            },
            "seek": {
                "success": [
                    "Успешно установил новое время", "Перемотал трек"
                ]
            }
        },
        "translator":       {
